...
#                 total_eval = class_to_cluster_evals[0] + class_to_cluster_evals[1] + class_to_cluster_evals[2] + 1.5 * n_clusters + silhouette_value - davies_value
